...
st.markdown("Met dit programma kan je zien hoe een bal op de grond stuitert met zelf gekozen variabelen") 
...
H               = st.slider("Drop height (m):", 0.1, 100.0, 1.0)
...
if st.button("🚀 Run simulation"):
    ...
    st.write("Highest points (m):", np.range(np.len(highest_points)), np.round(highest_points, 3))
